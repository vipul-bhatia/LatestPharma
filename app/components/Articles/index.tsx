            ...
            <div className="bg-lightgrey py-2" id="blog-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-4xl sm:text-4xl font-bold">OUR LATEST FEED</h3>
                        <br/>
                        <h4 className="text-2xl sm:text-2xl font-medium text-center text-lightblack">Risana Pharmaceuticals has recently expanded the product line to include medicines specifically designed for managing diabetic and cardiac problems. This addition underscores our commitment to addressing the diverse healthcare needs of our patients and ensuring they receive the highest quality care. Stay tuned for more updates.</h4>
                        <br/></div>
